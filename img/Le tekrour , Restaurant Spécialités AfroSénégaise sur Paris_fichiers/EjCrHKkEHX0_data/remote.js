...
L:"ytp-mdx-manual-pairing-popup-dialog",T:{role:"dialog"},R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-dialog-inner-content",R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-title",ba:"Nous allons bient\u00f4t supprimer la possibilit\u00e9 de se connecter \u00e0 un t\u00e9l\u00e9viseur via Internet \u00e0 l'aide d'un code"},{G:"div",L:"ytp-mdx-manual-pairing-popup-buttons",R:[{G:"button",ia:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],ba:"En savoir plus"},{G:"button",ia:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],
...
c=g.T(b,128)?g.sK("Erreur sur $RECEIVER_NAME",c):b.Hb()||g.T(b,4)?g.sK("Lecture sur $RECEIVER_NAME",c):g.sK("Connect\u00e9 \u00e0 $RECEIVER_NAME",c);a.za("statustext",c);a.u.show()}else a.u.hide()},$6=function(a,b){g.sR.call(this,"Lire sur",0,a,b);
...
this.gi={key:q4(),name:"Cet ordinateur"};this.nh=null;this.subscriptions=[];this.Rz=this.wb=null;this.gm=[this.gi];this.ol=this.gi;this.Mc=new g.SK(64);this.dE=0;this.Pe=-1;this.np=null;this.ls=this.yu=!1;this.Ln=this.Mp=null;if(!g.DD(this.player.S())){a=this.player;var b=g.MN(a);b&&(b=b.Cl())&&(b=new $6(a,b),g.C(this,b));b=new Z6(a);g.C(this,b);g.WN(a,b.element,4);this.Mp=new Y6;g.C(this,this.Mp);g.WN(a,this.Mp.element,4);g.P(this.player.S().experiments,"pair_servlet_deprecation_warning_enabled")&&
...
$6.prototype.ji=function(a){return"cast-selector-receiver"===a?"Caster sur\u2026":this.gm[a].name};
